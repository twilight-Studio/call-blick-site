...
const cells = [
  {
    ...
    desc: "Speaker-diarized transcripts with per-word confidence scores and 30+ language support — available in under 2 seconds.",
  ...
  },
  {
    ...
    desc: "Real-time alerts for missing disclosures, forbidden phrases, and regulatory violations — across 100% of calls.",
